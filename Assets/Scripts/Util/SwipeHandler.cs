...
using UnityEngine.UI;
		...
		public class SwipeHandler : MonoBehaviour
		{
				...
				void Start(){
                        ...
                        gachaMenu = GameObject.Find("Canvas").GetComponent<GachaMenu>();
                    }
				...
				private void HandleMobileSwipe ()
				{
                    ...
                    if (gachaMenu)
                    {
                        gachaMenu.move((-l * 200f));

                        gachaMenu.debugtext(l.ToString());
                    }
...
//										if (SW) {			
                                                ...
                                                if (gachaMenu) gachaMenu.swipePage(force);
        ...
        if (handleSwipes && Input.GetMouseButton(0) && mouseMove != 0)
        {
            ...
            if (gachaMenu)
            {
                gachaMenu.move((mouseMove * 10f));
                GachaMenu.islock = true;
            }
